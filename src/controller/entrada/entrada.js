...
exports.entrada = async (req, res) => {
    ...
    res.render('entrada/entrada.ejs', {rows_cliente, rows_servico, rows_descricao, rows_status, rows_numero_entrada})
...
exports.entrada_service = (req, res) =>{
    ...
    console.log('teste: ' + entrada_status_desc_identrada)
    console.log('teste2: ' + entrada_desc_identrada)
